...
assert_contains "$output" "dry run: verify extension label org.opencontainers.image.title=Shellharbor for OpenClaw on ghcr.io/jcowhigjr/openclaw-docker-desktop-extension:v1.2.3"
assert_contains "$output" "dry run: verify extension label org.opencontainers.image.title=Shellharbor for OpenClaw on ghcr.io/jcowhigjr/openclaw-docker-desktop-extension:1.2.3"
assert_contains "$output" "dry run: verify extension label org.opencontainers.image.title=Shellharbor for OpenClaw on docker.io/jcowhigjr/openclaw-docker-desktop-extension:1.2.3"
